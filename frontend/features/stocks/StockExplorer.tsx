...
export function StockExplorer() {
  ...
  const { data, isLoading, error } = useSWR(["stocks-catalog", limit], () => stocksService.list(limit), { refreshInterval: 60_000, keepPreviousData: true });

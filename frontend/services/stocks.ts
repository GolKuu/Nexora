...
import type { CrossAssetCompareResponse, DCFResult, InstrumentSearchResponse, StockCalculation, StockCard, StockEventsResponse, StockForecastPerformanceResponse, StockForecastResponse, StockHistoryResponse, StockListResponse } from "@/types/api";

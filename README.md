...
Основные пользовательские разделы frontend:

| маршрут | возможности |
| --- | --- |
| `/stocks` | полный каталог акций, поиск, сортировка и фильтры score |
| `/bonds` | полный каталог облигаций, тип, валюта, срок и сортировка |
| `/news` | общая дедуплицированная лента событий с источником и реакцией рынка |
| `/compare` | сравнение акций, облигаций и разных классов активов |
| `/portfolio` / `/watchlist` | портфели, P/L, концентрации и избранное |
| `/system` | KASE, БД, серверный мониторинг, источники и ошибки парсинга |

На мобильных устройствах главные разделы доступны из закреплённой нижней
навигации. Карточки акций и облигаций показывают историю цены, событий,
изменений исходных данных и point-in-time историю score.
